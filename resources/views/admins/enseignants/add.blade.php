                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    ...
                                    <button class="au-btn au-btn-icon au-btn--green">
                                        <i class="zmdi zmdi-plus"></i>Ajouter un enseignant</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="user-data m-b-30">
                ...
                <div class="table-responsive">
                    <div class="col-10 offset-1">
                        <div class="card">
                            <div class="card-header">Ajouter enseignant</div>
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="text-center title-2">Coordonnes</h3>
                                </div>
                                <hr>
                            <form action="{{ route('enseignantcreate')}}" method="post" >
                                @csrf
                                    <input  name="type" type="hidden" value="Enseignant" >
