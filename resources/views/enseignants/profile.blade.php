                                ...
                                <form action="" method="post" >
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  name="nom" type="text" class="form-control" value={{ auth()->user()->enseignant->nom }} >
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input  name="datenaiss" type="date" class="form-control cc-cvc" value={{ auth()->user()->enseignant->datenaissance }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="password" name="nationalite" type="text" class="form-control password identified visa" value={{ auth()->user()->enseignant->nationalite }}>
                                            <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                        </div>
                                        <div>
